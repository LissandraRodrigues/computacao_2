 ...
 *
 * $Author: luiza.rosa $
 * $Date: 2022/02/01 00:49:00 $
 * $Log: aula0706.c,v $
 * Revision 1.1  2022/02/01 00:49:00  luiza.rosa
 * Initial revision
 *
*/
...
main (int argc, char **argv) 
{
	...
	{
		printf ("\nUso: %s <tempo-congelamento> <numero-linhas> <numero-colunas> <percentual-defeituosos> <percentual-apagados> <linha-ponto> <coluna-ponto> <numero-vertices> <linha-vertice-1> <coluna-vertice-1> ... <linha-vertice-N> <coluna-vertice-N>\n\n", argv [0]);
	...
	for (contador = 1; contador < argc; contador++)
	{
		...
		if (((contador < 4) || (contador > 5)) && (contador < 9))
		{

			if ((argv [contador][0] == '0') && (contador != 1))
			{
				printf ("\nOs valores passados para quantidade de linhas, quantidade de colunas, coordenadas do ponto e numero de vertices nao podem ser nulos.\n\n");
				exit (ARGUMENTO_INVALIDO);
			}
		...
		else 
		{
			...
			if (quantidadeTotalElementos != (argc - 9))
			{
	...
	resultado = PreencherPoligono (tempoCongelamento, /* E */
										             monitor, /* E/S */
										             quantidadeLinhas,  /* E */
										             quantidadeColunas, /* E */
									               linha,  /* E */
	...
	{
		system ("clear");
		printf ("\nNao foi possivel preencher o poligono, ha a presenca de pixels defeituosos.\n\n");
		exit (LINHA_INVALIDA);
	}
